      ...
      {tab === 'overview' && (
        <div className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            ...
            <Stat label="Max DD" value={metrics.max_drawdown_pct != null ? `${metrics.max_drawdown_pct}%` : '—'} color="#f87171" />
            ...
            <Stat label="Robustness" value={`${robustness}/100`} color="#34d399" />
            <Stat label="Overfitting" value={`${overfit}/100`} color={overfit > 50 ? '#f87171' : '#facc15'} />
            <Stat label="Best Regime" value={String(s.config?.best_regime || '—')} color="#34d399" />
            <Stat label="Worst Regime" value={String(s.config?.worst_regime || '—')} color="#f87171" />
          </div>
