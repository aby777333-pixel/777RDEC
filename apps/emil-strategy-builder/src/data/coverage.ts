// Market, venue, broker & platform coverage for the EMIL Strategy Builder.
...
export const BROKERS_PLATFORMS = [
  `${BRAND.platform} Terminal`, 'MetaTrader 4', 'MetaTrader 5', 'TradingView', 'cTrader / cAlgo',
...
export const EXPORT_TARGETS = [
  ...
  { label: `${BRAND.platform} Module`, platform: `${BRAND.platform} native`, ext: 'json' },
