...
// The specialised agents that make up the EMIL Strategy Builder pipeline.
// Ordered as the research → generation → validation → deployment flow runs.
export const AGENTS: AgentMeta[] = [
  { name: 'MarketDataAgent', label: 'Market Data', icon: '📊', color: '#7dd3fc', description: 'Fetches OHLCV, ticks, order-book depth & funding across global venues' },
  ...
  { name: 'TechnicalIndicatorAgent', label: 'Indicators', icon: '📈', color: '#34d399', description: 'Computes SMA, RSI, MACD, ATR, Bollinger, Supertrend, VWAP & more' },
  { name: 'StrategyGenerationAgent', label: 'Strategy Gen', icon: '🧠', color: '#7dd3fc', description: 'Synthesises rule-based, factor & ML strategy hypotheses' },
  ...
  { name: 'RiskCheckAgent', label: 'Risk Check', icon: '🛡️', color: '#fbbf24', description: 'Validates drawdown, leverage, exposure & tail-risk limits' },
  { name: 'RankingAgent', label: 'Ranking', icon: '🏆', color: '#fbbf24', description: 'Weighted multi-metric scoring — never return alone' },
  { name: 'VotingAgent', label: 'Debate & Vote', icon: '🗳️', color: '#34d399', description: 'Aggregates multi-agent debate into a final consensus vote' },
