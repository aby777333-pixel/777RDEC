      ...
      <div className="flex items-start justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-sm text-subtext">
            Live market data via the {BRAND.platform} Market API (Finnhub · EODHD · Twelve Data · Yahoo · Binance).
      ...
      {isLoading ? (
        ...
        <ResponsiveContainer width="100%" height={360}>
          <ComposedChart data={candles} barCategoryGap="20%">
            ...
            <XAxis dataKey="i" stroke="#979da6" fontSize={10} />
            <YAxis stroke="#979da6" fontSize={10} domain={['auto', 'auto']} orientation="right" />
            <Tooltip
              contentStyle={{ background: '#0e1218', border: '1px solid #262d38', borderRadius: 8, fontSize: 12 }}
            ...
            <Line type="monotone" dataKey="close" stroke="#7dd3fc" strokeWidth={1} dot={false} opacity={0.35} isAnimationActive={false} />
          </ComposedChart>
        </ResponsiveContainer>
      )}
