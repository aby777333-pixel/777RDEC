    ...
    <Card>
      ...
      <div className="flex flex-col gap-2">
        ...
        <label className="flex items-center gap-2 text-sm cursor-pointer">
          <input type="checkbox" checked={enabled} onChange={(e) => setEnabled(e.target.checked)} className="accent-[#7dd3fc]" />
    ...
    <Card>
      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <input type="range" min={0.5} max={5} step={0.1} value={risk} onChange={(e) => setRisk(+e.target.value)} className="w-full accent-[#7dd3fc]" />
        </div>
        <div>
          <div className="flex justify-between text-xs mb-1">
          ...
          <input type="range" min={100} max={5000} step={50} value={dailyLimit} onChange={(e) => setDailyLimit(+e.target.value)} className="w-full accent-[#f87171]" />
        </div>
        <div>
          <div className="flex justify-between text-xs mb-1">
          ...
          <input type="range" min={0.5} max={5} step={0.1} value={atr} onChange={(e) => setAtr(+e.target.value)} className="w-full accent-[#fbbf24]" />
        </div>
      </div>
    </Card>
  );
  ...
  return (
    <Card>
      ...
      <div className="mb-3">
        ...
        <input type="range" min={0} max={100} step={5} value={threshold} onChange={(e) => setThreshold(+e.target.value)} className="w-full accent-[#7dd3fc]" />
      </div>
