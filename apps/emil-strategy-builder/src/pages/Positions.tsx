        ...
        <Card className="xl:col-span-2">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={equityData}>
              ...
              <YAxis stroke="#979da6" fontSize={10} domain={['auto', 'auto']} tickFormatter={(v) => `$${(v / 1000).toFixed(0)}k`} />
              <Tooltip
                contentStyle={{ background: '#0e1218', border: '1px solid #262d38', borderRadius: 8, fontSize: 12 }}
                formatter={(v: number) => `$${fmtMoney(v)}`}
              />
              <Area type="monotone" dataKey="equity" stroke="#34d399" fill="url(#pf)" strokeWidth={2} dot={false} />
            </AreaChart>
          </ResponsiveContainer>
        </Card>
            ...
            <div>
              ...
              <div className="w-full h-3 rounded-full bg-bg overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${riskPct}%`,
                    background: riskPct > 80 ? '#f87171' : riskPct > 50 ? '#fbbf24' : '#34d399',
                    boxShadow: `0 0 8px ${riskPct > 80 ? '#f87171' : '#34d399'}`,
                  }}
                />
              </div>
