...
const PLATFORM_ADMIN = `${BRAND.platform} Admin`;

const ROLES = [
  'Super Admin', PLATFORM_ADMIN, 'Risk Manager', 'Dealer', 'Compliance Officer',
...
const GRANTS: Record<string, string[]> = {
  'Super Admin': PERMS,
  [PLATFORM_ADMIN]: ['Data', 'Research', 'Create', 'Code', 'Backtest', 'Approve', 'Deploy', 'Accounts', 'Risk limits', 'API keys', 'Audit log', 'Kill switch'],
