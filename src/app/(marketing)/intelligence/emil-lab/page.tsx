...
export default function EmilLabPage() {
  return (
    <>
      {/* THE FINAL 0.001 SECOND: an order's first millisecond, behind the hero. */}
      <PageHero eyebrow={copy.eyebrow} heading={copy.heading} lead={copy.lead} backdrop="execution">
